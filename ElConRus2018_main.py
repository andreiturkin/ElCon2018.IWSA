...
if __name__ == '__main__':
    ...
    print'                              Figure 1a                                        '
    # Get the workspace
    GetSolution_woS(0.2, rhomin = 8.0, rhomax = 12.0, \
    ...
    print'                              Figure 3a                                        '
    # Get the workspace
    GetSolution_wS(0.2, rhomin = 8.0, rhomax = 12.0, \
                         thetamin = pi/16.0, thetamax = pi - pi/16.0, \
                         fig = '3a', ShowRes=True)
    print'                              Figure 3b                                        '
    # Get the workspace
    ...
    print'###############################################################################'
    print'                             Table 1'
    Table1_deltas = [0.5, 0.25, 0.2, 0.14, 0.07, 0.05, 0.03]
    pbar = progressbar.ProgressBar(maxval=len(Table1_deltas), \
